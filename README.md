...
buttons you want and pick a board (Pro Micro / RP2040 / ESP32-S3), and get:
...
- a ready-to-flash Arduino `.ino` HID sketch
...
v1 supports momentary buttons only. Toggles, rotary encoders, and
